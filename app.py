...
app.layout = html.Div(
    ...
    html.Div([
        ...
        dcc.Input(id='fixed_acidity', type='number', required=True, style={'padding': '10px'}),    
        html.Label("Volatile Acidity"),
        dcc.Input(id='volatile_acidity', type='number', required=True, style={'padding': '10px'}), 
        html.Label("Citric Acid"),
        dcc.Input(id='citric_acid', type='number', required=True, style={'padding': '10px'}),
        html.Br(),
        
        html.Label("Residual Sugar"),
        dcc.Input(id='residual_sugar', type='number', required=True, style={'padding': '10px'}),  
        html.Label("Chlorides"),
        dcc.Input(id='chlorides', type='number', required=True, style={'padding': '10px'}), 
        html.Label("Free Sulfur Dioxide"),
        dcc.Input(id='free_sulfur_dioxide', type='number', required=True, style={'padding': '10px'}),
        html.Br(),
        
        html.Label("Total Sulfur Dioxide"),
        dcc.Input(id='total_sulfur_dioxide', type='number', required=True, style={'padding': '10px'}),
        html.Label("Density"),
        dcc.Input(id='density', type='number', required=True, style={'padding': '10px'}),
        html.Label("pH"),
        dcc.Input(id='ph', type='number', required=True, style={'padding': '10px'}),
        html.Br(),
